...
export const Route = createFileRoute("/agenda/$slug/personalizado")({
  ...
  head: ({ loaderData }) => ({
    meta: [
      ...
      { name: "description", content: `Escolha uma duração personalizada para seu atendimento em ${loaderData?.establishment.name ?? "nosso estabelecimento"}.` },
    ],
  }),
  component: CustomDurationRoute,
  errorComponent: () => <div className="p-8 text-center text-sm text-muted-foreground">Não foi possível carregar o agendamento personalizado agora.</div>,
